...
if ! JAVA_HOME=/Applications/SimplifyQA-CodeEditor.app/Contents/Resources/app/resources/jdk/Contents/Home /Applications/SimplifyQA.app/Contents/dist/agent/libs/apache-maven-3.9.9/bin/mvn compile exec:java -Dexec.mainClass="com.simplifyqa.codeeditor.helper.DuplicateIdChecker"; then
